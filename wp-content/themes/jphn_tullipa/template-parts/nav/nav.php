        ...
        <div class="top-bar-left ">
            <ul class="dropdown vertical medium-horizontal  menu " data-dropdown-menu>
                ...
                <li><a href="#">Compétences</a>
                    <ul class="menu">
                        <li style="background-color: #fff"><a href="<?php echo home_url().'#php';?>">PHP</a></li>
                        <li style="background-color: #fff"><a href="<?php echo home_url().'#js';?>">Javascript</a></li>
                    </ul>
                </li>
                <li><a href="<?php echo home_url().'#demos';?>">Réalisation</a></li>
                <li><a href="<?php echo home_url().'##experience_pro';?>">Expérience</a></li>
