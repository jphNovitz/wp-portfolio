<section id="about" class="row m2">
    <article class="columns small-12 medium-4 align-middle">
        <h4 class="article-title">A propos</h4>
        <div class="big lead">
            Tu veux un site internet sans te ruiner ? Je n'ai pas un bureau avec un belle vue ni une voiture de
            fonction,
    ...
    <div class="columns small-12 medium-push-1 medium-7 align-middle">
        <div class="row">
            ...
            <article class="card columns small-6  large-5 large-offset-1">
                ...
                <div class="card-description">Votre commerce en ligne</div>
                <div class="card-section">Woocomerce, prestashop: tout est possible pour développer votre chiffre
                    d'affaire. Surtout en cette période de confinement !
                </div>
            </article>
        </div>
        <div class="row">
            <article class="card columns small-6 large-5">
                <div class="card-divider">Projet MVP</div>
                <div class="card-description">Montrez du concret</div>
                <div class="card-section">Vous souhaitez vous lancez, besoin d'un site fonctionnel pour convaincre ?
                    Réaliser un Minimum Viable Product.
                </div>
            </article>
            <article class="card columns small-6  large-5 large-offset-1">
                <div class="card-divider">Une idée particulière ?</div>
                <div class="card-description">Site internet sur mesure</div>
                <div class="card-section">Symfony, Laravel, Wordpress, PHP, Javascript.</div>
            </article>
        </div>
