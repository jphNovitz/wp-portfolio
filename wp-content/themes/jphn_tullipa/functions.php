...
//        wp_enqueue_style( 'style', get_stylesheet_directory_uri().'/assets/css/style.css' );    
        wp_enqueue_script('jquery1', get_stylesheet_directory_uri() . './foundation-portfolio/node_modules/jquery/dist/jquery.min.js', [], true, true);  
         
        wp_enqueue_script('jquery2', get_stylesheet_directory_uri() . '/foundation-portfolio/node_modules/jquery/dist/jquery.min.js', [], true, true);   
