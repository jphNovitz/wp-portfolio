...
//        wp_enqueue_style( 'style', get_stylesheet_directory_uri().'/assets/css/style.css' );     
        ...
        wp_enqueue_script('foundation', get_stylesheet_directory_uri() . '/foundation-portfolio/node_modules/foundation-sites/dist/js/foundation.min.js', array(), true, true);
