...
//        wp_enqueue_script('javascript', get_stylesheet_directory_uri().'/assets/js/main.js');
        wp_enqueue_script('what-input', get_stylesheet_directory_uri().'/foundation-portfolio/node_modules/what-input/dist/what-input.js');
        wp_enqueue_script('foundation', get_stylesheet_directory_uri().'/foundation-portfolio/node_modules/foundation-sites/dist/js/foundation.js');
